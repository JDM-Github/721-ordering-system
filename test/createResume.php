...
<body>
    ...
    <div class="form-container">
        ...
        <form action="process-resume.php" method="POST" id="resumeForm" enctype="multipart/form-data"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" id="address" name="address" value="<?= $address ?>"
                placeholder="Enter your address" required <?= $disabled ?>>
        </div>
        <div class="mb-3">
        ...
        <button onclick="alert('Do you need help?')" class="btn btn-outline-success btn-sm w-100 mt-3">Need
            Help?</button>
        <p class="text-center mt-3">Already created a resume? <a href="resumePage.php" class="text-success">View
                Resume</a></p>
    </div>
